 ...
 * *no* device pixel ratio - forcing 1:1 scaling
 * with crisp pixel rendering.
 *
...
Runner.updateCanvasScaling = function(canvas, opt_width, opt_height) {
  ...
  // Always use scale 1:1 regardless of device pixel ratio
  ...
  return false; // No scaling applied
};
